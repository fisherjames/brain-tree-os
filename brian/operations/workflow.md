...
9. Ship only after dry-run passes and human verification is recorded.
10. Generate and publish briefing after meaningful progress.
11. Update `[[execution-plan]]` and handoff note before ending the session.
