...
6. Use Product Owner View for squad-context decisions before escalating to tribe.
7. Use Mission Control for squad execution, verification, and merge queue.
8. Generate and publish briefing after meaningful progress.
9. Update `[[execution-plan]]` and handoff note before ending the session.
