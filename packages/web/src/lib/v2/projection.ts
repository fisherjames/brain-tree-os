...
export function loadDecisions(brainPath: string): V2Decision[] {
  ...
  return records.map((record) => {
    ...
    return {
      ...
      title,
      initiativeId: fm.initiative_id,
      proposalId: fm.proposal_id || undefined,
      proposalPath: fm.proposal_path || undefined,
      discussionId: fm.discussion_id || undefined,
      discussionPath: fm.discussion_path || undefined,
